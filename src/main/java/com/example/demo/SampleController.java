...
public class SampleController {
	...
	// http://localhost:8080/usersecond/test?param=くええええええええ
	@GetMapping("/test")
	...
	// http://localhost:8080/usersecond/all
	@GetMapping("/all")
	...
	// なかしへの課題
	// http://localhost:8080/usersecond/search
	@GetMapping("/search")
	public User getOneUser(@RequestParam Integer id) { //ここで、Userは引数の型
	...
	// 自分でかいてみる
	// http://localhost:8080/usersecond/allsecond
	@GetMapping("/allsecond")
	public List<User> getAllUser() {
		List<User> allUserList = new ArrayList<>();
		for (int i = 1; i < 10; i++) {
			User user = new User();
